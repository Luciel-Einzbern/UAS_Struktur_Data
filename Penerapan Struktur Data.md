...
131: Fungsi boolean dequeue digunakan untuk mengeluarkan jadwal pertandingan terdepan dari Queue. Mengembalikan nilai true jika berhasil, false jika queue kosong.
...
148 - 158: Fungsi menambahkan node pada stack riwayat pertandingan.
...
261 - 282: Fungsi menampilkan ranking statistik pemain individual.
262 - 271: Perulangan Bubble Sort untuk mengurutkan pemain berdasarkan statistik goal/assist individual. 
284 - 345: Fungsi pencatatan dan inisialisasi pertandingan
347: Fungsi menginisialisasi data Klub (input data klub dilakukan melalui fungsi ini)
348 - 352: Perulangan inisialisasi seluruh elemen dari Adjacency Matrix historiGraph menjadi false (belum ada pertandingan sama sekali di awal turnamen).
354 - 361: Inisialisasi fungsi untuk membuat object klub baru dengan menggunakan pendekatan modern Lambda Expression buatKlub untuk mempermudah instansiasi klub, dimana nama variabel/tipe data penampung fungsi ditentukan oleh compiler.
335 - 359: Inisialisasi klub baru ke dalam program.
363: Inisialisasi data tim dan pertandingan dummy untuk testing

3. Function Main: Hanya digunakan untuk menginisialiasi semua fungsi berbasarkan pilihan user pada menu.
